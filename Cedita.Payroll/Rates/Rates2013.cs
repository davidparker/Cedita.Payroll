...
{
    internal class Rates2013 : IRateYear
    {
        ...
        public List<TaxBracket> Brackets
        {
            get
            {
                ...
                {
                    new TaxBracket { From = 0, To = 32010, Multiplier = 0.2m },
                    new TaxBracket { From = 32010, To = 150000, Multiplier = 0.4m },
                    new TaxBracket { From = 150000, To = Int32.MaxValue, Multiplier = 0.45m },
                };
            }
        }

        public string DefaultTaxCode { get { return "944L"; } }

        public decimal LowerEarningsLimit { get { return 5668; } }
        public decimal UpperEarningsLimit { get { return 41450; } }
        public decimal PrimaryThreshold { get { return 7755; } }
        public decimal SecondaryThreshold { get { return 7696; } }
        public decimal UpperAccrualPoint { get { return 40040; } }

        public decimal StudentLoanThreshold { get { return 16365; } }
