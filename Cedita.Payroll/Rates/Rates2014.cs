...
{
    internal class Rates2014 : IRateYear
    {
        ...
        public List<TaxBracket> Brackets
        {
            get
            {
                ...
                {
                    new TaxBracket { From = 0, To = 31865, Multiplier = 0.2m },
                    new TaxBracket { From = 31865, To = 150000, Multiplier = 0.4m },
                    new TaxBracket { From = 150000, To = Int32.MaxValue, Multiplier = 0.45m },
                };
            }
        }

        public string DefaultTaxCode { get { return "1000L"; } }

        public decimal LowerEarningsLimit { get { return 5772; } }
        public decimal UpperEarningsLimit { get { return 41865; } }
        public decimal PrimaryThreshold { get { return 7956; } }
        public decimal SecondaryThreshold { get { return 7956; } }
        ...
        public decimal PensionLowerThreshold { get { return 5772m; } }
        public decimal PensionAutomaticEnrolment { get { return 10000m; } }
        public decimal PensionUpperThreshold { get { return 41865m; } }
    }
}
